...
def get_dataloaders(
    ...
    train_size, val_size = int(split[0] * len(full_dataset)), int(split[1] * len(full_dataset))
    ...
    samplers = {
        ...
        'test': DistributedSampler(test_dataset, shuffle=False) if distributed else None
    }
    ...
    logger.info(f'Dataloaders created: Train={len(dataloaders["train"])} batches, '
