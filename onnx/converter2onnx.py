...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--path', default="/home/wzc/project/uNet/tr/exp6/checkpoint-14.pth.tar", type=str, help='Absolute path to load PyTorch model and export onnx model')
    parser.add_argument(
        '--example_img_path', default="/home/wzc/project/uNet/sample_train_data", type=str, help='example input path ')
